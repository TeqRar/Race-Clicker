...
Infinite.Text = "Auto Run Fast"
Infinite.TextColor3 = Color3.fromRGB(255, 255, 255)
Infinite.TextSize = 20.000


local function UMTQ_fake_script() -- Auto click LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
       ...
       Basic.BackgroundColor3 = Color3.fromRGB(0, 170, 0)
       while wait() do
            if click ~= 2 then
...
local function EKBNYI_fake_script() --Auto Farm.LocalScript 
    ...
    script.Parent.MouseButton1Down:Connect(function()
       ...
       Character.HumanoidRootPart.CFrame = CFrame.new(-36.79207229614258, 2.998020887374878, -0.5722557306289673)*CFrame.Angles(0,math.rad(90),0)
       while wait() do
        if debounce == true then
          ...
          if click ~= 2 then
             print("run")
             Character.HumanoidRootPart.CFrame = Character.HumanoidRootPart.CFrame*CFrame.new(0,0,-20000)
